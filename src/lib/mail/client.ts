...
export async function sendEmail(params: SendEmailParams): Promise<{ id: string } | { error: any }> {
  ...
  const from = params.from || process.env.MAIL_FROM || "Oncolink <notifications@oncolink.ro>";
  ...
  return `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #1e293b; line-height: 1.6;">
      <div style="text-align: center; margin-bottom: 30px;">
        ...
        <h2 style="margin: 0; font-weight: 900; letter-spacing: -0.025em; text-transform: uppercase; font-size: 20px;">Oncolink — Management Clinic</h2>
      </div>
      ...
      <p style="font-size: 11px; color: #94a3b8; text-align: center;">
        Acest email a fost trimis automat de către platforma Oncolink.<br/>
